...
It seems like there is an effect of contrast: Response times for a contrast difference of .75 are slower than for a difference of .25. There also is an effect of feedback: Wrong responses are slower than correct ones. Lastly, there is a strong contrast x feedback interaction: Response times are slower for wrong responses, but mainly at a contrast difference of .75.
